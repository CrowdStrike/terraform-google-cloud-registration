...
| <a name="input_excluded_project_patterns"></a> [excluded\_project\_patterns](#input\_excluded\_project\_patterns) | List of regex patterns for projects to exclude from CrowdStrike registration | `list(string)` | `[]` | no |
